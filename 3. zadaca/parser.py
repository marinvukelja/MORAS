...
class Parser:
    def __init__(self, filename):
        ...
        self._parse_while()
        if self._flag == False:
            Parser._error("WHL", self._line, self._errm)
            return
    ...
    from parseMacro import _parse_macros, _parse_macro, _init_macro
    from parseWhile import _parse_while, _p_while, _init_mac
